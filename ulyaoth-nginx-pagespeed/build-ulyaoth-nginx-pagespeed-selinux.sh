...
cd /home/ulyaoth/
su ulyaoth -c "wget https://raw.githubusercontent.com/ulyaoth/repository/master/ulyaoth-nginx-pagespeed/SELinux/ulyaoth-nginx-pagespeed.txt"
...
su ulyaoth -c "wget https://raw.githubusercontent.com/ulyaoth/repository/master/ulyaoth-nginx-pagespeed/SPECS/ulyaoth-nginx-pagespeed-selinux.spec"
if [ "$arch" != "x86_64" ]
then
...
if type dnf 2>/dev/null
then
  dnf builddep -y ulyaoth-nginx-pagespeed-selinux.spec
elif type yum 2>/dev/null
then
  yum-builddep -y ulyaoth-nginx-pagespeed-selinux.spec
fi

su ulyaoth -c "rpmbuild -ba ulyaoth-nginx-pagespeed-selinux.spec"
