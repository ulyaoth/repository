...
ulyaoth-mbedtls2.5()
{
wget https://raw.githubusercontent.com/ulyaoth/repository/master/ulyaoth-mbedtls/build-ulyaoth-mbedtls2.5.sh ; chmod +x build-ulyaoth-mbedtls2.5.sh ; ./build-ulyaoth-mbedtls2.5.sh
}
...
scppackage()
{
chown ec2-user:ec2-user /root/*.rpm
mv /root/*.rpm /home/ec2-user/
}
