...
su ulyaoth -c "wget https://raw.githubusercontent.com/sbagmeijer/ulyaoth/master/Repository/ulyaoth-solr/SPECS/ulyaoth-solr5-examples.spec"
...
su ulyaoth -c "rpmbuild -bb ulyaoth-solr5-examples.spec"
