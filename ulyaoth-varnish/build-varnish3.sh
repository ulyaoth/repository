...
then
  sed -i "s/jemalloc-devel/memkind-devel/g" /home/ulyaoth/rpmbuild/SPECS/ulyaoth-varnish3.spec
  sed -i "s/jemalloc/memkind/g" /home/ulyaoth/rpmbuild/SPECS/ulyaoth-varnish3.spec
fi
