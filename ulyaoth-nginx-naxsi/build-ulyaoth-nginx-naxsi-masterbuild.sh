...
then
  dnf builddep -y ulyaoth-nginx-naxsi-masterbuild.spec
elif type yum 2>/dev/null
then
  yum-builddep -y ulyaoth-nginx-naxsi-masterbuild.spec
fi
...
su ulyaoth -c "mv naxsi.tar.gz /home/ulyaoth/rpmbuild/SOURCES/"
cd /home/ulyaoth/rpmbuild/SPECS/
su ulyaoth -c "rpmbuild -ba ulyaoth-nginx-naxsi-masterbuild.spec"
