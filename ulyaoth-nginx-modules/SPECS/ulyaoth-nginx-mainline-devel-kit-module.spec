...
%define module_devel_kit_release  15%{?dist}
...
%changelog
* Sun May 12 2019 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.com> 0.3.0-15
- Recompiled with Nginx Mainline 1.15.12.

* Fri Nov 9 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.com> 0.3.0-14
- Updated nginx mainline to 1.15.6.

* Wed Jun 13 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.com> 0.3.0-13
- Updated nginx mainline to 1.15.0.

* Wed May 23 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 0.3.0-12
- Updated nginx mainline to 1.13.12.

* Sat Jan 6 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 0.3.0-11
- Updated nginx mainline to 1.13.8.

* Wed Aug 9 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 0.3.0-10
- Updated nginx mainline to 1.13.4.

* Sat Jul 1 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 0.3.0-9
- Updated nginx mainline to 1.13.2.

* Tue May 30 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 0.3.0-8
- Updated nginx mainline to 1.13.1.

* Sat May 20 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.3.0-7
- Updated nginx mainline to 1.13.0.
- Updated nsj to 0.1.10.

* Sat Feb 25 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.3.0-6
- Recompiled with Nginx Mainline 1.11.10.
- Updated nsj to 0.1.9.

* Sat Nov 26 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.3.0-5
- Updated to Nginx Mainline 1.11.6.
- Updated nsj to 0.1.5.

* Sat Oct 15 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.3.0-4
- Recompiled with Nginx Mainline 1.11.5.

* Wed Sep 14 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.3.0-3
- Recompiled with Nginx Mainline 1.11.4.

* Sat Aug 20 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.3.0-2
- Recompiled with Nginx Mainline 1.11.3.

* Sun Jun 19 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.3.0-1
- Initial release for devel kit module.