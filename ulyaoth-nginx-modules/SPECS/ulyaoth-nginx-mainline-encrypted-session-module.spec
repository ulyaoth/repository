...
%define module_encrypted_session_version  0.08
...
%package module-encrypted-session
Version: %{module_encrypted_session_version}
Release: %{module_encrypted_session_release}
Group: %{_group}
Requires: ulyaoth-nginx-mainline
...
%{__mv} %{_builddir}/nginx-%{main_version}/objs/ngx_http_encrypted_session_module.so \
    %{_builddir}/nginx-%{main_version}/objs/ngx_http_encrypted_session_module-debug.so
./configure %{COMMON_CONFIGURE_ARGS} \
    --with-cc-opt="%{WITH_CC_OPT}" \
    %{?perlldopts}
make %{?_smp_mflags}
...
%{__install} -m644 %{_builddir}/nginx-%{main_version}/objs/ngx_http_encrypted_session_module.so \
    $RPM_BUILD_ROOT%{_libdir}/nginx/modules/ngx_http_encrypted_session_module-debug.so
...
%files module-encrypted-session
%attr(0644,root,root) %{_libdir}/nginx/modules/ngx_http_encrypted_session_module.so
%attr(0644,root,root) %{_libdir}/nginx/modules/ngx_http_encrypted_session_module-debug.so
...
%post module-encrypted-session
if [ $1 -eq 1 ]; then
    cat <<BANNER
----------------------------------------------------------------------

The encrypted session dynamic module for nginx has been installed.
To enable this module, add the following to /etc/nginx/nginx.conf
and reload nginx:
...
%changelog
* Fri Nov 9 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.com> 0.08-3
- Updated nginx mainline to version 1.15.6.

* Wed Jun 13 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.com> 0.08-2
- Updated nginx mainline to version 1.15.0.

* Wed May 23 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 0.08-1
- Updated encrypted-session module to version 0.08.
- Updated nginx mainline to version 1.13.12.
...
* Sat Jul 1 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 0.06-8
- Updated nginx mainline to 1.13.2.

* Tue May 30 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.06-7
- Updated nginx mainline to 1.13.1.

* Sat May 20 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.06-6
- Updated nginx mainline to 1.13.0.
- Updated nsj to 0.1.10.

* Sat Feb 25 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.06-5
- Recompiled with Nginx Mainline 1.11.10.
- Updated nsj to 0.1.9.

* Sat Nov 26 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.06-4
- Updated to Nginx Mainline 1.11.6.
- Updated nsj to 0.1.5.

* Sat Oct 15 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.06-3
- Recompiled with Nginx Mainline 1.11.5.

* Wed Sep 14 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.06-2
