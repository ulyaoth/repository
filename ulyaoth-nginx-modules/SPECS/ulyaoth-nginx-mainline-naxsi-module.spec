...
%define module_naxsi_release  3%{?dist}
...
%{__mv} %{_builddir}/nginx-%{main_version}/objs/ngx_http_naxsi_module.so \
    %{_builddir}/nginx-%{main_version}/objs/ngx_http_naxsi_module-debug.so
./configure %{COMMON_CONFIGURE_ARGS} \
    --with-cc-opt="%{WITH_CC_OPT}" \
    %{?perlldopts}
make %{?_smp_mflags}
...
%changelog
* Sun May 12 2019 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.com> 0.56-3
...
* Wed Aug 9 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 0.55.3-5
- Updated nginx mainline to 1.13.4.

* Sat Jul 1 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 0.55.3-4
- Updated nginx mainline to 1.13.2.

* Tue May 30 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.55.3-3
- Updated nginx mainline to 1.13.1.

* Sat May 20 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.55.3-2
- Updated nginx mainline to 1.13.0.
- Updated nsj to 0.1.10.

* Sat Feb 25 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.55.3-1
- Updated to Naxsi 0.55.3.
- Compiled with Nginx Mainline 1.11.10.
- Updated nsj to 0.1.9.

* Sat Nov 26 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.55.1-3
- Updated to Nginx Mainline 1.11.6.
- Updated nsj to 0.1.5.

* Sat Oct 15 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.55.1-2
...
* Sat Aug 20 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.55-0.2.rc2
- Recompiled with Nginx Mainline 1.11.3.

* Sat Jun 25 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 0.55-0.1.rc2
- Initial release for naxsi module.