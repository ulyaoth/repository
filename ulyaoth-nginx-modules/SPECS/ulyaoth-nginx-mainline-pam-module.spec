...
%define module_pam_release  14%{?dist}
...
%define COMMON_CONFIGURE_ARGS $(echo "\
        ...
        --with-file-aio \
        --add-dynamic-module=/home/ulyaoth/pam-module \
...
%{__mv} %{_builddir}/nginx-%{main_version}/objs/ngx_http_auth_pam_module.so \
    %{_builddir}/nginx-%{main_version}/objs/ngx_http_auth_pam_module-debug.so
./configure %{COMMON_CONFIGURE_ARGS} \
    --with-cc-opt="%{WITH_CC_OPT}" \
    %{?perlldopts}
make %{?_smp_mflags}
...
%{__install} -m644 %{_builddir}/nginx-%{main_version}/objs/ngx_http_auth_pam_module-debug.so \
    $RPM_BUILD_ROOT%{_libdir}/nginx/modules/ngx_http_auth_pam_module-debug.so
...
%files module-pam
%attr(0644,root,root) %{_libdir}/nginx/modules/ngx_http_auth_pam_module.so
%attr(0644,root,root) %{_libdir}/nginx/modules/ngx_http_auth_pam_module-debug.so
...
The pam dynamic module for nginx has been installed.
To enable this module, add the following to /etc/nginx/nginx.conf
and reload nginx:
...
%changelog
* Fri Nov 9 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.com> 1.5.1-14
- Updated nginx mainline to 1.15.6.

* Wed Jun 13 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.com> 1.5.1-13
- Updated nginx mainline to 1.15.0.

* Wed May 23 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 1.5.1-12
- Updated nginx mainline to 1.13.12.

* Sat Jan 6 2018 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 1.5.1-11
- Updated nginx mainline to 1.13.8.

* Wed Aug 9 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 1.5.1-10
- Updated nginx mainline to 1.13.4.

* Sat Jul 1 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 1.5.1-9
- Updated nginx mainline to 1.13.2.

* Tue May 30 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 1.5.1-8
- Updated nginx mainline to 1.13.1.

* Sat May 20 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 1.5.1-7
- Updated nginx mainline to 1.13.0.
- Updated nsj to 0.1.10.

* Sat Feb 25 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 1.5.1-6
- Recompiled with Nginx Mainline 1.11.10.
- Updated nsj to 0.1.9.

* Sat Nov 26 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 1.5.1-5
- Updated to Nginx Mainline 1.11.6.
- Updated nsj to 0.1.5.

* Sat Oct 15 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 1.5.1-4
- Recompiled with Nginx Mainline 1.11.5.

* Wed Sep 14 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 1.5.1-3
- Recompiled with Nginx Mainline 1.11.4.

* Sat Aug 20 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 1.5.1-2
- Recompiled with Nginx Mainline 1.11.3.

* Sun Jun 19 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 1.5.1-1
- Initial release for pam module.