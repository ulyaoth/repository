...
%define module_passenger5_version    5.3.7
...
%post module-passenger5
if [ $1 -eq 1 ]; then
    cat <<BANNER
----------------------------------------------------------------------

The passenger 5 dynamic module for nginx has been installed.
To enable this module, add the following to /etc/nginx/nginx.conf
and reload nginx:
...
%changelog
* Sun May 12 2019 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.com> 5.3.7-1
- Updated Passenger 5 to 5.3.7.
...
* Wed Aug 9 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 5.1.7-1
- Updated Nginx Mainline to 1.13.4.
- Updated Passenger 5 to 5.1.7.

* Sat Jul 1 2017 Sjir Bagmeijer <sjir.bagmeijer@ulyaoth.net> 5.1.5-1
- Updated Nginx Mainline to 1.13.2.
- Updated Passenger 5 to 5.1.5.

* Tue May 30 2017 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 5.1.4-2
