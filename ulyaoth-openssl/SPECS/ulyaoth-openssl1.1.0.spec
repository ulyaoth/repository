...
Provides: ulyaoth-openssl1.1.0pre1
...
%build
./config --openssldir=/usr/local/ulyaoth/ssl/openssl1.1.0 no-ssl2 no-ssl3
make depend
make all
make rehash
make %{?_smp_mflags}
...
%changelog
* Sun Jan 10 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 1.1.0pre1-1
