...
Provides: ulyaoth-openssl1.0.2g
...
%build
./config --openssldir=/usr/local/ulyaoth/ssl/openssl1.0.2 no-ssl2 no-ssl3 shared
make depend
make all
make rehash
make %{?_smp_mflags}
...
Thanks for using ulyaoth-openssl1.0.2!
...
%changelog
* Sat Feb 27 2016 Sjir Bagmeijer <sbagmeijer@ulyaoth.net> 1.0.2g-1
