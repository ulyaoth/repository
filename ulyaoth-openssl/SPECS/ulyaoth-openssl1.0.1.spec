...
mv $RPM_BUILD_ROOT/usr/local/ulyaoth/openssl1.0.1/misc/* $RPM_BUILD_ROOT/usr/local/ulyaoth/openssl1.0.1/bin/
rm -rf $RPM_BUILD_ROOT/usr/local/ulyaoth/openssl1.0.1/certs
rm -rf $RPM_BUILD_ROOT/usr/local/ulyaoth/openssl1.0.1/private
rm -rf $RPM_BUILD_ROOT/usr/local/ulyaoth/openssl1.0.1/misc
...
%doc /usr/local/ulyaoth/openssl1.0.1/man/man1*/*
%doc /usr/local/ulyaoth/openssl1.0.1/man/man5*/*
%doc /usr/local/ulyaoth/openssl1.0.1/man/man7*/*
...
%attr(0755,root,root) /usr/local/ulyaoth/openssl1.0.1/lib/libcrypto.so.1.0.0
%attr(0755,root,root) /usr/local/ulyaoth/openssl1.0.1/lib/libssl.so.1.0.0
%attr(0755,root,root) /usr/local/ulyaoth/openssl1.0.1/lib/engines/*
...
%doc /usr/local/ulyaoth/openssl1.0.1/man/man3*/*
...
/usr/local/ulyaoth/openssl1.0.1/bin/CA.sh
/usr/local/ulyaoth/openssl1.0.1/bin/c_hash
/usr/local/ulyaoth/openssl1.0.1/bin/c_info
/usr/local/ulyaoth/openssl1.0.1/bin/c_issuer
/usr/local/ulyaoth/openssl1.0.1/bin/c_name
%doc /usr/local/ulyaoth/openssl1.0.1/man/man1*/*.pl*
%doc /usr/local/ulyaoth/openssl1.0.1/man/man1*/c_rehash*
%doc /usr/local/ulyaoth/openssl1.0.1/man/man1*/tsget*
