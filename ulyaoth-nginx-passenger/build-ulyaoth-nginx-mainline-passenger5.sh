...
su ulyaoth -c "wget https://github.com/openresty/headers-more-nginx-module/archive/v0.29.tar.gz"
su ulyaoth -c "tar xvf v0.29.tar.gz"
su ulyaoth -c "mv headers-more-nginx-module-0.29 /etc/nginx/modules/headersmore"
su ulyaoth -c "rm -rf v0.29.tar.gz"
...
wget http://s3.amazonaws.com/phusion-passenger/releases/passenger-5.0.28.tar.gz
tar xvf passenger-5.0.28.tar.gz
mv passenger-5.0.28 passenger
...
then
  dnf builddep -y ulyaoth-nginx-mainline-passenger5.spec
elif type yum 2>/dev/null
then
  yum-builddep -y ulyaoth-nginx-mainline-passenger5.spec
fi

su ulyaoth -c "spectool ulyaoth-nginx-mainline-passenger5.spec -g -R"
