...
then
  dnf builddep -y ulyaoth-nginx-mainline-passenger4.spec
elif type yum 2>/dev/null
then
  yum-builddep -y ulyaoth-nginx-mainline-passenger4.spec
fi

su ulyaoth -c "spectool ulyaoth-nginx-mainline-passenger4.spec -g -R"
